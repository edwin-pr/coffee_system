...
$save_supplier = mysqli_query($con,"INSERT INTO suppliers(suppliername,supplierphone, idnumber, supplierlocation,suppliertype,briefinfo,supplier_status) VALUES('$suppliername','$supplierphone', '$idnumber', '$supplierlocation','$suppliertype','$briefinfo','active')");
