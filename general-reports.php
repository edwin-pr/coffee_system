...
<!-- <div class="card m-3 border-warning shadow col-md-3" style="height:160px;border:1px solid crimson;cursor: pointer;" onclick="window.open('suppliers-report2.php?time=1')">
  
<center>
  
  <div style="width:80px; height: 80px; border-radius:100%" class="shadow-sm">
    <i class="fa fa-users text-warning text-center mt-4" style="font-size:30px;"></i>
  </div>
  <br>
  <div class="shadow-sm text-warning text-capitalize" style="width:60%;">
    <small>Suppliers' Supply Report</small>
  </div>
